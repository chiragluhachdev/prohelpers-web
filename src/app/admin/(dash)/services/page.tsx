...
import { QuestionEditor, type ServiceOption } from "@/components/QuestionEditor";
import {
  Badge, Button, Card, Cell, EmptyState, ErrorNote, Field, Input,
  Modal, PageHeader, Row, SkeletonRows, Table, Textarea, Toggle,
} from "@/components/ui";

export type { ServiceOption } from "@/components/QuestionEditor";
...
export default function ServicesPage() {
  ...
  const services = allServices
    .filter((s) =>
      !needle ||
      [s.name, s.code, s.description].some((v) => String(v || "").toLowerCase().includes(needle)),
    )
  ...
  return (
    <>
      ...
      <Modal
        ...
        subtitle="Asked when a customer books this service, in their language. Each answer can add to the price and to how long the job takes — the app shows only what you set here."
      ...
      >
        ...
        <div className="max-h-[56vh] overflow-y-auto pr-1">
          <QuestionEditor options={optDraft} onChange={setOptDraft} />
        </div>
